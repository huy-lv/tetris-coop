...
export declare enum TetrominoType {
    I = "I",
    O = "O",
    T = "T",
    S = "S",
...
export interface ServerToClientEvents {
    room_joined: (room: Omit<Room, 'players'> & {
        players: Player[];
    }) => void;
...
export interface ClientToServerEvents {
    create_room: (playerName: string, callback: (response: {
        success: boolean;
        roomCode?: string;
        error?: string;
    }) => void) => void;
    join_room: (roomCode: string, playerName: string, callback: (response: {
        success: boolean;
        error?: string;
    }) => void) => void;
    leave_room: () => void;

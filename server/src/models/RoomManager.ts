...
export class RoomManager {
  ...
  joinRoom(roomCode: string, playerName: string): { success: boolean; room?: Room; player?: Player; error?: string } {
    console.log(`🔍 RoomManager.joinRoom: Looking for room code "${roomCode}"`);
    console.log(`📋 Available room codes: [${Array.from(this.roomCodes.keys()).join(', ')}]`);
